...
| **Feed** | `Feed/` | Fil d'actualité : `Feed.vue` (⚠️ encore en Options API), `PostList.vue`, `Post.vue`, `widgets/ShareButton.vue`, `SharedThumbnail.vue`. Fan-out serveur par les Jobs `SendPostToFollowers`. |
