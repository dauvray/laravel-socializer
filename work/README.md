...
|---|---|---|
| [webrtc2-securite-2026-08-14.md](webrtc2-securite-2026-08-14.md) | 🔴 **le plus urgent**, démarré — **lot A terminé** (A1+A2+A3, 15/08) ; **B2 est la suivante** (débloquée par A2, `[S]`, réutilise le même prédicat) | 15 tâches en 6 lots pour fermer le sens **sortant** des connexions, durcir l'entrant, sécuriser les 5 routes backend et sortir les credentials TURN du bundle. Le sens sortant est désormais gardé côté client (`utils/isAuthorizedPeer.js`) : reste la récolte de peerId (B2), l'usurpation intra-room (B0→B1) et tout le **backend**, où vit la version autoritative du garde (C2). |
