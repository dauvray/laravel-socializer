...
|---|---|---|
| [webrtc2-securite-2026-08-14.md](webrtc2-securite-2026-08-14.md) | 🔴 **le plus urgent**, démarré — **lot A terminé** (A1+A2+A3), **B2** et **B0** faits (15/08) ; **B1 est la suivante**, et B0 a tranché sa forme | 15 tâches en 6 lots pour fermer le sens **sortant** des connexions, durcir l'entrant, sécuriser les 5 routes backend et sortir les credentials TURN du bundle. Côté client, le prédicat unique `utils/isAuthorizedPeer.js` garde désormais les deux sorties du contexte : l'ouverture de connexion (A2) et la livraison du peerId (B2). B0 a mesuré que le mapping peerId est **absent** à l'admission sur tout le chemin présence : B1 ne peut donc pas fusionner ses deux chemins, il durcit l'anti-usurpation sans exiger la résolution. Reste B1 et tout le **backend**, où vit la version autoritative du garde (C2). |
