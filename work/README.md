...
| [front-todo.md](front-todo.md) | **non démarré** | items front transverses, hors module : le nommage des directives de resize, et deux whispers écrits en direct contre Echo qui échappent au compteur de consommateurs. |
| [serveur-todo.md](serveur-todo.md) | 🟠 ouvert | module Serveur. Un seul item, et c'est un **arbitrage produit à trancher avant tout code** : « présent » doit-il vouloir dire *onglet ouvert* (actuel) ou *fenêtre au premier plan* ? |
