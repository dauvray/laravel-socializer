...
1. Le module WebRTC2 au fil de l'eau : [webrtc2-todo.md](webrtc2-todo.md),
   ...
   > 1. **Les tâches 6 et 7 du plan de tests**, débloquées le 29/08 : de loin le plus gros
